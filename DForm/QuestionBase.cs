...
namespace DForm
{
    ...
    public abstract class QuestionBase
    {
        ...
        public AnswerBase Response { get; set; }
        ...
        public QuestionBase AddChild( Type questionType )
        {
            QuestionBase q = (QuestionBase)Activator.CreateInstance( questionType, this );
            _children.Add( q );
            return q;
        }
